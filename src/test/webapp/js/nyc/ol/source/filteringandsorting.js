...
QUnit.test('sort', function(assert){
	...
	var test = function(){
		...
		$.each(source.sort(nyc.CENTER), function(_, feature){
			var line = new ol.geom.LineString([feature.getCoordinates(), nyc.CENTER]);
	...
	new ol.layer.Vector({source: source, map: this.TEST_MAP});
});
